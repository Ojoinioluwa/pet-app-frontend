          ...
          <KeyboardAvoidingView behavior='padding' className=''>
            <View className='p-5 mt-2'>
              ...
              <View className='flex justify-center items-center mt-3'>
                <TouchableOpacity disabled={isPending}  className='px-3 py-4 rounded-3xl  w-full mt-3 bg-blue-950' onPress={handleLogin}>
                  {isPending ? <ActivityIndicator color="white" /> : <Text className='text-white font-rubik-extrabold text-lg text-center'>Login</Text>}
                </TouchableOpacity>
              </View>
            </View>
