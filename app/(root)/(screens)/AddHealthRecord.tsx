...
import { Button, KeyboardAvoidingView, ScrollView, Text, TextInput, TouchableOpacity, View } from 'react-native';
...
const validationSchema = Yup.object({
  ...
  type: Yup.string().oneOf(["Checkup", "Treatment", "Deworming", "Vaccination"]).required("Type field is required"),
              ...
              <View className="flex-1 items-center justify-center px-5 mt-5 gap-5">
                ...
                <View className="w-full flex gap-2">
                  ...
                  {formik.touched.title && formik.errors.title && (
                    <Text className="text-red-600 text-sm">{formik.errors.title}</Text>
                  )}
                </View>
                ...
                <View className="w-full flex gap-2">
                    ...
                    {formik.touched.description && formik.errors.description && (
                      <Text className="text-red-600 text-sm">{formik.errors.description}</Text>
                    )}
                ...
                <View className="w-full flex gap-2">
                    ...
                    {formik.touched.cost && formik.errors.cost && (
                      <Text className="text-red-600 text-sm">{formik.errors.cost}</Text>
                    )}
                </View>
                {/* Date field */}
                 <View>
                ...
                <View className="w-full flex gap-2">
                    ...
                    {formik.touched.veterinarian && formik.errors.veterinarian && (
                      <Text className="text-red-600 text-sm">{formik.errors.veterinarian}</Text>
                    )}
                </View>

              <TouchableOpacity className="bg-blue-950 rounded-3xl w-full px-2 py-5 mt-5"
               onPress={formik.handleSubmit} disabled={isPending}>
